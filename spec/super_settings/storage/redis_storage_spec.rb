  ...
  describe SuperSettings::Storage::RedisStorage do
    ...
    describe "history" do
      it "should fetch the setting history" do
        ...
        setting.save!
        SuperSettings::Storage::RedisStorage.create_history(key: "key", value: "1", changed_by: "me", created_at: Time.now - 30)
        SuperSettings::Storage::RedisStorage.create_history(key: "key", value: "2", changed_by: "you", created_at: Time.now - 20)
        SuperSettings::Storage::RedisStorage.create_history(key: "key", deleted: true, changed_by: "Bob", created_at: Time.now - 10)
