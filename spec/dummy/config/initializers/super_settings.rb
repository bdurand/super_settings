unless ENV["SUPER_SETTINGS_NO_OVERRIDES"].present?
  SuperSettings.configure do |config|
    ...
    config.application_link = "/" # {controller: "super_settings/settings", action: :index}
    ...
    config.settings_controller_superclass = ::ApplicationController
    config.settings_controller_definition do
      before_action do
